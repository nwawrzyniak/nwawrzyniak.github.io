function setBGfromRGB() {
  var red, green, blue = "";
  var r = parseInt(document.getElementById('redValue').value);
  var g = parseInt(document.getElementById('greenValue').value);
  var b = parseInt(document.getElementById('blueValue').value);
